...
newConfig = do
    ...
    return $ GiteaConfig
        { configHost = "http://localhost/api/v1"
        , configUserAgent = "gitea-api/1.15.9.0"
...
setHeader :: GiteaRequest req contentType res accept -> [NH.Header] -> GiteaRequest req contentType res accept
...
setQuery :: GiteaRequest req contentType res accept -> [NH.QueryItem] -> GiteaRequest req contentType res accept
setQuery req query = 
  req &
  L.over
